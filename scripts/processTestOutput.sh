...
cat ./artifacts/chrome.ndjson | ./scripts/cucumber-json-formatter --format ndjson  > ./artifacts/chrome.json
cat ./artifacts/firefox.ndjson | ./scripts/cucumber-json-formatter --format ndjson  > ./artifacts/firefox.json
